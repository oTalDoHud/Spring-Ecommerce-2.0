...
import com.hudlucas.springeccomerce.repositories.ClienteRepository;
...
public class ClienteService {
    ...
    @Autowired
    ClienteRepository clienteServiceRepository;



    public Cliente findById(Integer id){
        Optional<Cliente> obj = clienteServiceRepository.findById(id);
